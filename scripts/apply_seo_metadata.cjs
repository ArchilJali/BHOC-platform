...
const socialBase='https://evidence.bhoctherapeutics.com';
const authorProfile='https://www.linkedin.com/in/archil-jaliashvili-bhoc/';
const homeSocialImage=`${socialBase}/assets/bhoc-evidence-social-preview.png`;
...
function managedBlock(file,data){
  ...
  const socialImageAlt='BHOC Scientific Evidence';
