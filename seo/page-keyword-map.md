...
| CORE | `/veterinary/Vet-fda-ema.html` | Oxyglobin FDA and EMA regulatory records | Oxyglobin FDA approval; Oxyglobin EMA authorization; NADA 141-067; canine anemia; veterinary regulation | Primary regulatory source page | Clarify historical Oxyglobin record versus future BHOC development | Vet hub; Oxyglobin cornerstone; FDA source; EMA source | **EXISTING — preserve URL** |
...
1. **Oxyglobin regulatory intent** belongs to `Vet-fda-ema.html` and its FDA/EMA source pages.
2. **Oxyglobin bibliography intent** belongs to `publication-catalogue.html`, `Vet-search.html` and the existing publication pages.
