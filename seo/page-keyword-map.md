...
| `/transplant/Transplant-index.html` | oxygen carriers in transplantation | BHOC; HBOC; organ perfusion; machine perfusion; ischemia reperfusion; liver; kidney; heart |
| `/transplant/Transplant-search.html` | HBOC and BHOC transplantation evidence | HBOC; BHOC; HBOC-201; Hemopure; organ perfusion; machine perfusion; transplantation evidence; liver; kidney; heart |
...
| `/science/nobel-foundations-oxygen-metabolism-physiology.html` | oxygen metabolism and physiology foundations | oxygen sensing; hypoxia; HIF; mitochondrial oxygen biology; vascular physiology; Nobel foundations |
| `/science/nitric-oxide-scavenging-hboc-vasoconstriction.html` | nitric oxide scavenging and HBOC vasoconstriction | cell-free hemoglobin; vasoconstriction; hypoxic vasodilation; microcirculation; HBOC safety physiology; BHOC science |
...
| `/historical-sources/biopure-annual-report-2001/` | Biopure 2001 oxygen therapeutics history | Hemopure; HBOC-201; Oxyglobin; acute anemia; prehospital blood logistics; manufacturing history |
| `/historical-sources/biopure-annual-report-2002/` | Biopure 2002 Hemopure and trauma history | Hemopure; HBOC-201; Oxyglobin; prehospital trauma; military research; FDA BLA history; oxygen delivery |
...
10. The science page `nitric-oxide-scavenging-hboc-vasoconstriction.html` owns NO-scavenging and vasoconstriction intent. The LinkedIn evidence page `hemoglobin-beta-cys93-nitric-oxide-tissue-oxygenation.html` owns tissue oxygenation, hemoglobin and HBOC intent and must not compete for NO-scavenging terms.
11. The PPH page owns postpartum hemorrhage, donor blood and PBM intent. Avoid using generic “blood access” as its primary keyword phrase; use blood, donor blood, patient blood management and PBM in context.
12. No new page is marked READY until it has a unique title/H1, evidence set, source-qualified claims, Oxyglobin/BHOC bridge, internal-link plan and no unresolved overlap with an existing canonical page.
