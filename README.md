...
<!-- ============================================================ -->
<!-- DOCUMENTATION - ALL 5 CARDS IN ONE ROW                       -->
<!-- ============================================================ -->
  ...
  <table style="border-collapse: collapse; border: none; margin: 0 auto;">
    <tr>
      <td align="center" style="border: 2px solid #1a365d; border-radius: 10px; padding: 25px 12px; width: 145px; background-color: #ffffff;">
        ...
        <br>
        <strong style="font-size: 15px; color: #1a365d;">Veterinary</strong><br>
      ...
      <td align="center" style="border: 2px solid #1a365d; border-radius: 10px; padding: 25px 12px; width: 145px; background-color: #ffffff;">
        ...
        <small style="font-size: 11px; color: #718096;">Application</small>
        <br><br>
        <a href=". " style="text-decoration: none; color: #1a365d; font-weight: 600; border: 2px solid #1a365d; border-radius: 6px; padding: 5px 14px; display: inline-block; font-size: 11px;">Explore →</a>
      </td>
      <td style="width: 12px;"></td>
      <td align="center" style="border: 2px solid #1a365d; border-radius: 10px; padding: 25px 12px; width: 145px; background-color: #ffffff;">
      ...
      <td align="center" style="border: 2px solid #1a365d; border-radius: 10px; padding: 25px 12px; width: 145px; background-color: #ffffff;">
        <div style="font-size: 36px;">🔬</div>
        <br>
        <strong style="font-size: 15px; color: #1a365d;">Scientific</strong><br>
      ...
      <td align="center" style="border: 2px solid #1a365d; border-radius: 10px; padding: 25px 12px; width: 145px; background-color: #ffffff;">
        <div style="font-size: 36px;">📱</div>
        <br>
        <strong style="font-size: 15px; color: #1a365d;">LinkedIn</strong><br>
        <small style="font-size: 11px; color: #718096;">Publications</small>
        <br><br>
        <a href="./social-media/linkedin/" style="text-decoration: none; color: #1a365d; font-weight: 600; border: 2px solid #1a365d; border-radius: 6px; padding: 5px 14px; display: inline-block; font-size: 11px;">Explore →</a>
      </td>
    </tr>
  </table>
</p>
...
<p align="center">
  <table style="border-collapse: collapse; border: none; margin: 0 auto;">
    <tr>
      <td align="center" style="border: 2px solid #1a365d; border-radius: 10px; padding: 20px 10px; width: 150px; background-color: #ebf8ff;">
        <div style="font-size: 28px;">📍</div>
        <br>
        <strong style="font-size: 17px; color: #1a365d;">WHERE</strong><br>
        <small style="font-size: 11px; color: #4a5568;">Where is oxygen needed?</small>
      </td>
      <td style="width: 10px;"></td>
      <td align="center" style="border: 2px solid #1a365d; border-radius: 10px; padding: 20px 10px; width: 150px; background-color: #e6fffa;">
        <div style="font-size: 28px;">⏰</div>
        <br>
        <strong style="font-size: 17px; color: #1a365d;">WHEN</strong><br>
        <small style="font-size: 11px; color: #4a5568;">When is additional oxygen delivery required?</small>
      </td>
      <td style="width: 10px;"></td>
      <td align="center" style="border: 2px solid #1a365d; border-radius: 10px; padding: 20px 10px; width: 150px; background-color: #fefcbf;">
        <div style="font-size: 28px;">📊</div>
        <br>
        <strong style="font-size: 17px; color: #1a365d;">HOW MUCH</strong><br>
        <small style="font-size: 11px; color: #4a5568;">How much oxygen is required to support tissue demand?</small>
      </td>
      <td style="width: 10px;"></td>
      <td align="center" style="border: 2px solid #1a365d; border-radius: 10px; padding: 20px 10px; width: 150px; background-color: #fed7d0;">
        <div style="font-size: 28px;">🎮</div>
        <br>
        <strong style="font-size: 17px; color: #1a365d;">CONTROL</strong><br>
        <small style="font-size: 11px; color: #4a5568;">How can oxygen delivery be supported in a controlled and continuous manner?</small>
      </td>
    </tr>
  </table>
</p>
...
<table>
  <tr>
    <td style="border: 2px solid #1a365d; border-radius: 10px; padding: 15px 20px; background-color: #f7fafc;">
    ...
    <td style="border: 2px solid #1a365d; border-radius: 10px; padding: 20px 25px; background-color: #f7fafc;">
      ...
      <table style="border-collapse: collapse; border: none;">
        <tr>
          ...
          <td style="border: none; padding: 3px 10px;">• Cellular and protein components critical to osmotic pressure fluid balance</td>
        </tr>
        <tr>
  ...
  <tr>
    <td style="border: 2px solid #1a365d; border-radius: 10px; padding: 20px 25px; background-color: #f7fafc;">
      ...
      <table style="border-collapse: collapse; border: none;">
        ...
        <tr>
          <td style="border: none; padding: 3px 10px;">• Veterinary medicine and all animal health</td>
