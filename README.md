...
<h1 align="center" style="color: #1a365d; font-size: 42px;">🩸 BHOC</h1>
<h2 align="center" style="color: #2d3748; font-size: 24px; font-weight: normal;">Biological Hemoglobin Oxygen Carrier</h2>
...
<!-- ============================================================ -->
<!-- PRECISION OXYGEN THERAPEUTICS - Box Cards                    -->
<!-- ============================================================ -->
...
<!-- ============================================================ -->
<!-- TISSUE-LEVEL OXYGEN DELIVERY - Box                           -->
<!-- ============================================================ -->
  ...
  <tr>
    <td style="border: 2px solid #1a365d; border-radius: 10px; padding: 20px; background-color: #f7fafc;">
      ...
      <table style="border-collapse: collapse; border: none;">
        <tr>
          <td style="border: none; padding: 4px 10px;">• Oxygen content</td>
          <td style="border: none; padding: 4px 10px;">• Cardiac output</td>
        </tr>
        <tr>
          <td style="border: none; padding: 4px 10px;">• Microcirculation</td>
          <td style="border: none; padding: 4px 10px;">• Oxygen extraction</td>
        </tr>
        <tr>
          <td style="border: none; padding: 4px 10px;">• Diffusion</td>
          <td style="border: none; padding: 4px 10px;">• Tissue oxygen demand</td>
        </tr>
        <tr>
          <td style="border: none; padding: 4px 10px;">• Cellular oxygen utilization</td>
...
<table>
  <tr>
    <td style="border: 2px solid #1a365d; border-radius: 10px; padding: 20px; background-color: #f7fafc;">
      ...
      <br><br>
      <details>
        <summary><strong>📋 View important scientific concepts</strong></summary>
        <br>
        <table style="border-collapse: collapse; border: 1px solid #ddd;">
          <tr>
            <td style="border: 1px solid #ddd; padding: 8px;"><strong>Hemoglobin</strong></td>
            <td style="border: 1px solid #ddd; padding: 8px;">Hemoglobin, Oxygen binding, Oxygen dissociation, P50, Oxygen unloading, 2,3-DPG</td>
          </tr>
          <tr>
            <td style="border: 1px solid #ddd; padding: 8px;"><strong>Physiology</strong></td>
            <td style="border: 1px solid #ddd; padding: 8px;">Nitric oxide biology, Microcirculation, Oxygen extraction, DO₂, VO₂, Tissue oxygenation</td>
          </tr>
          <tr>
            <td style="border: 1px solid #ddd; padding: 8px;"><strong>Pathology</strong></td>
            <td style="border: 1px solid #ddd; padding: 8px;">Ischemia, Reperfusion</td>
          </tr>
        </table>
      </details>
    </td>
...
<table>
  <tr>
    <td style="border: 2px solid #1a365d; border-radius: 10px; padding: 20px; background-color: #f7fafc;">
      ...
      <table style="border-collapse: collapse; border: none;">
        <tr>
          <td style="border: none; padding: 4px 10px;">• Oxygen carrier transport and distribution</td>
          <td style="border: none; padding: 4px 10px;">• Cellular and protein components critical to osmotic pressure fluid balance</td>
        </tr>
        <tr>
          <td style="border: none; padding: 4px 10px;">• Carbon dioxide transport</td>
          <td style="border: none; padding: 4px 10px;">• Coagulation</td>
        </tr>
        <tr>
          <td style="border: none; padding: 4px 10px;">• Immune system management functions</td>
          <td style="border: none; padding: 4px 10px;">• Acid-base regulation as well as ionic balance</td>
        </tr>
        <tr>
          <td style="border: none; padding: 4px 10px;">• Signaling and other biological functions</td>
          <td style="border: none; padding: 4px 10px;"></td>
        </tr>
      </table>
      <br>
      ...
      <br><br>
      <strong>Therefore, BHOCs have been developed and evaluated as an immediate and complementary oxygenation support, rather than as a substitute for all functions of blood.</strong>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td style="border: 2px solid #1a365d; border-radius: 10px; padding: 20px; background-color: #f7fafc;">
      ...
      <br><br>
      <details>
        <summary><strong>📋 View all research areas</strong></summary>
        <br>
        <table style="border-collapse: collapse; border: none;">
          <tr>
            <td style="border: none; padding: 4px 10px; width: 50%;">• Hemoglobin-Based Oxygen Carriers (HBOCs)</td>
            <td style="border: none; padding: 4px 10px; width: 50%;">• Oxygen Therapeutics</td>
          </tr>
          <tr>
            <td style="border: none; padding: 4px 10px;">• Precision Oxygenation</td>
            <td style="border: none; padding: 4px 10px;">• Tissue Oxygenation</td>
          </tr>
          <tr>
            <td style="border: none; padding: 4px 10px;">• Oxygen Delivery</td>
            <td style="border: none; padding: 4px 10px;">• Transfusion Medicine</td>
          </tr>
          <tr>
            <td style="border: none; padding: 4px 10px;">• Artificial Blood Research</td>
            <td style="border: none; padding: 4px 10px;">• Blood Substitutes</td>
          </tr>
          <tr>
            <td style="border: none; padding: 4px 10px;">• Microvascular Oxygenation</td>
            <td style="border: none; padding: 4px 10px;">• Ischemia and Reperfusion</td>
          </tr>
          <tr>
            <td style="border: none; padding: 4px 10px;">• Organ Preservation</td>
            <td style="border: none; padding: 4px 10px;">• Machine Perfusion</td>
          </tr>
          <tr>
            <td style="border: none; padding: 4px 10px;">• Trauma</td>
            <td style="border: none; padding: 4px 10px;">• Emergency Medicine</td>
          </tr>
          <tr>
            <td style="border: none; padding: 4px 10px;">• Prehospital Medicine</td>
            <td style="border: none; padding: 4px 10px;">• Surgery</td>
          </tr>
          <tr>
            <td style="border: none; padding: 4px 10px;">• Veterinary Medicine</td>
            <td style="border: none; padding: 4px 10px;">• Disease management and control</td>
          </tr>
        </table>
      </details>
    </td>
...
<table>
  <tr>
    <td style="border: 2px solid #1a365d; border-radius: 10px; padding: 20px; background-color: #f7fafc;">
      ...
      <table style="border-collapse: collapse; border: none;">
        <tr>
          <td style="border: none; padding: 4px 10px; width: 50%;">• Trauma and acute blood loss</td>
          <td style="border: none; padding: 4px 10px; width: 50%;">• Prehospital and emergency medicine</td>
        </tr>
        <tr>
          <td style="border: none; padding: 4px 10px;">• Surgery</td>
          <td style="border: none; padding: 4px 10px;">• Organ preservation and transplantation</td>
        </tr>
        <tr>
          <td style="border: none; padding: 4px 10px;">• Machine perfusion</td>
          <td style="border: none; padding: 4px 10px;">• Ischemia and reperfusion</td>
        ...
        <tr>
          <td style="border: none; padding: 4px 10px;">• Veterinary medicine and all animal health</td>
          <td style="border: none; padding: 4px 10px;">• Blood-supply constrained environments</td>
        </tr>
        <tr>
          <td style="border: none; padding: 4px 10px;">• Resource-limited healthcare settings</td>
          <td style="border: none; padding: 4px 10px;"></td>
        </tr>
      </table>
      <br>
      <em>Applications must be evaluated according to the available scientific and clinical evidence. Animal health models and experience can prescreen logistics and value of immediate intervention.</em>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td style="border: 2px solid #1a365d; border-radius: 10px; padding: 20px; background-color: #f7fafc;">
      ...
      <table style="border-collapse: collapse; border: none;">
        <tr>
          <td style="border: none; padding: 4px 10px; width: 33%;">• Scientific publications</td>
          <td style="border: none; padding: 4px 10px; width: 33%;">• Research summaries</td>
          <td style="border: none; padding: 4px 10px; width: 33%;">• Preclinical studies</td>
        </tr>
        <tr>
          <td style="border: none; padding: 4px 10px;">• Clinical research</td>
          <td style="border: none; padding: 4px 10px;">• Oxygen physiology</td>
          <td style="border: none; padding: 4px 10px;">• Technology development</td>
        </tr>
        <tr>
          <td style="border: none; padding: 4px 10px;">• References and datasets</td>
          <td style="border: none; padding: 4px 10px;">• Scientific discussions</td>
          <td style="border: none; padding: 4px 10px;"></td>
        </tr>
      </table>
      <br>
...
<table>
  <tr>
    <td style="border: 2px solid #1a365d; border-radius: 10px; padding: 20px; background-color: #f7fafc;">
      ...
      <table style="border-collapse: collapse; border: none;">
        <tr>
          <td style="border: none; padding: 4px 10px; width: 33%;">• BHOC</td>
          <td style="border: none; padding: 4px 10px; width: 33%;">• HBOCs</td>
          <td style="border: none; padding: 4px 10px; width: 33%;">• Oxygen Therapeutics</td>
        </tr>
        <tr>
          <td style="border: none; padding: 4px 10px;">• Hemoglobin physiology</td>
          <td style="border: none; padding: 4px 10px;">• Oncology</td>
          <td style="border: none; padding: 4px 10px;">• Iron support</td>
        </tr>
        <tr>
          <td style="border: none; padding: 4px 10px;">• Wound healing</td>
          <td style="border: none; padding: 4px 10px;">• Metabolism and mitochondrial support</td>
          <td style="border: none; padding: 4px 10px;">• Oxygen delivery</td>
        </tr>
        <tr>
          <td style="border: none; padding: 4px 10px;">• Tissue oxygenation</td>
        ...
        <tr>
          <td style="border: none; padding: 4px 10px;">• Emergency medicine</td>
          <td style="border: none; padding: 4px 10px;">• Animal healthcare applications</td>
          <td style="border: none; padding: 4px 10px;"></td>
        </tr>
      </table>
      <br>
...
<!-- ============================================================ -->
<!-- SCIENTIFIC PRINCIPLES 2 (Oxygen Pathway) - Box               -->
<!-- ============================================================ -->
...
<table>
  <tr>
    <td style="border: 2px solid #1a365d; border-radius: 10px; padding: 20px; background-color: #f7fafc;">
      ...
      <br><br>
      <code>
      <strong>Oxygen Supply</strong> (lung and membrane oxygenation and anti-oxidation control)<br>
      ↓<br>
      <strong>Oxygen Transport</strong> (rheology and diffusion support, ECMO)<br>
      ↓<br>
      <strong>Microvascular Distribution</strong> (perfusion and concentration)<br>
      ↓<br>
      <strong>Tissue Oxygen Availability</strong> (extraction and control)<br>
      ↓<br>
...
<table>
  <tr>
    <td style="border: 2px solid #1a365d; border-radius: 10px; padding: 25px; background-color: #f7fafc; text-align: center;">
      <strong style="font-size: 18px; color: #1a365d;">Archil Jaliashvili</strong><br>
      <em style="font-size: 15px; color: #4a5568;">Biotechnology & Healthcare Innovation</em><br><br>
      <strong style="font-size: 15px; color: #1a365d;">BHOC — Biological Hemoglobin Oxygen Carrier</strong><br>
      <em style="font-size: 14px; color: #4a5568;">Precision Oxygen Therapeutics</em>
    </td>
  </tr>
</table>
